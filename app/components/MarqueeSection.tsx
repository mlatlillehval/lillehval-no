  ...
  return (
    <section id="pagaende-prosjekter" style={{ background: "#edf4ea" }} className="py-20 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 mb-12">
        <SectionKicker>Pågående prosjekter</SectionKicker>
          ...
          {allCards.map((card, i) => (
            ...
            >
              <div className="relative w-full" style={{ height: "200px" }}>
                ...
                />
                <span
                  className="absolute top-3 left-3 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide !text-white"
                  style={{
